...
import z from 'zod';
import { sendContactEmailAction } from '@/components/actions/contact';
  ...
  return (
    <section id='contact' className='max-w-360 mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-12 md:py-24'>
      ...
      >
        ...
        <p className='text-muted-foreground max-w-2xl mx-auto'>{contactSection.description}</p>
      </motion.div>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value}>
                            ...
                            <SelectContent>
                              {contactSection.reasons?.map((reason) => (
