...
export default function SponsorsSection() {
  ...
  return (
    <section id='sponsors' className='container max-w-360 mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-12 md:py-24'>
      ...
      >
        <h2 className='text-3xl md:text-4xl font-bold'>{portfolioData.sponsors.sectionTitle}</h2>
        {portfolioData.sponsors.sectionDescription && (
          <p className='text-muted-foreground max-w-2xl mx-auto'>{portfolioData.sponsors.sectionDescription}</p>
        )}
      </motion.div>
