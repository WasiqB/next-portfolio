...
export const Data: PortfolioData = {
  ...
  services: {
    ...
    services: [
      {
        id: "test-automation-assessment",
        title: "Test Automation Health Check",
        description:
          "Comprehensive audit of your automation strategy to boost efficiency and ROI.",
        icon: "Settings2",
        features: [
          "Full audit of test suites, frameworks, and CI/CD pipelines",
          "Performance benchmarking against industry standards",
          "Actionable roadmap with prioritized improvements",
        ...
        deliverables: [
          {
            ...
            description:
              "Free 45-min consultation to understand your automation challenges.",
            details: [
              "Process review & pain point identification",
          ...
          },
          {
            ...
            description: "Technical analysis of your automation ecosystem.",
            details: [
              "Framework architecture review",
              "Test coverage analysis",
              "CI/CD pipeline evaluation",
              "Flakiness and performance audit",
            ],
            icon: "🔍",
            duration: "3-5 days",
            cost: "Project-based",
          },
          {
            ...
            description: "Prioritized action plan for maximum impact.",
            details: [
              "Gap analysis report",
          ...
          },
          {
            ...
            description: "Handover session with your engineering team.",
            details: [
              "Findings walkthrough",
              "Q&A and implementation guidance",
              "30-day support commitment",
            ],
            icon: "🚀",
            duration: "2 hours",
            cost: "Included",
      ...
      {
        id: "test-automation-implementation",
        title: "End-to-End Automation Implementation",
        description:
          "Scalable test frameworks for Web, Mobile, API & Desktop applications.",
        icon: "Code2",
        features: [
          "Custom framework development with best practices",
          "Cross-browser/device testing integration",
        ...
        deliverables: [
          {
            ...
            description: "Define scope, tools, and success metrics.",
            details: [
          ...
          },
          {
            ...
            description: "Agile implementation with continuous demos.",
            details: [
              "Bi-weekly progress reviews",
              "Early smoke test deployment",
          ...
          },
          {
            ...
            description: "Hands-on knowledge transfer to your team.",
            details: [
              "Defect resolution",
          ...
          },
          {
            ...
            description: "CI/CD integration with ongoing support.",
            details: [
      ...
      },
      {
        ...
        title: "Automation Rescue & Support",
        description:
          "Rapid troubleshooting for flaky tests and pipeline failures.",
        icon: "Headphones",
        features: [
          "Emergency debugging for failing test suites",
        ...
        deliverables: [
          {
            ...
            description: "Immediate triage call to assess urgency.",
            details: ["Issue categorization", "Access setup", "SLA agreement"],
            icon: "🚑",
            duration: "30 mins",
            cost: "Free",
          },
          {
            step: "02",
            title: "Diagnosis & Solution Design",
            description: "Deep dive into technical issues.",
            details: [
            ...
            cost: "Hourly/retainer",
          },
          {
            step: "03",
            title: "Hotfix Deployment",
            description: "Immediate resolution delivery.",
            details: [
          ...
          {
            step: "04",
            title: "Prevention Blueprint",
            description: "Long-term stability recommendations.",
            details: [
              "Post-mortem report",
      ...
      {
        id: "test-automation-maintenance",
        title: "Automation Maintenance Program",
        description:
          "Proactive upkeep for sustained automation health and efficiency.",
        icon: "ShieldCheck",
        features: [
        ...
        deliverables: [
          {
            ...
            description: "Baseline assessment of automation health.",
            details: [
          ...
          {
            step: "02",
            title: "Care Plan Activation",
            description: "Tailored maintenance schedule.",
            details: [
      ...
      },
      {
        ...
        title: "Test Automation Content Studio",
        description:
          "Engaging technical content that builds authority and trust.",
        icon: "Pen",
        features: [
          "Tutorials for your testing tools/APIs",
          "Case studies demonstrating automation ROI",
          "Trend analysis in test automation",
        ...
        deliverables: [
          {
            ...
            description: "Align content with audience needs.",
            details: [
              "Audience analysis",
              "Topic ideation",
              "Content calendar",
          ...
          },
          {
            ...
            description: "Expert creation with technical review.",
            details: [
              "Draft development",
            ...
            icon: "✍️",
            duration: "5-10 days",
            cost: "Per piece/milestone",
          },
          {
            step: "03",
            title: "Review & Optimization",
            description: "SEO and engagement refinement.",
            details: [
      ...
      },
      {
        ...
        title: "Automation Accelerator Program",
        description: "Customized coaching for teams and individuals.",
        icon: "LifeBuoy",
        features: [
          "Personalized learning paths",
          "Framework-specific workshops",
          "Code review sessions",
          "CI/CD configuration labs",
        ...
        deliverables: [
          {
            ...
            description: "Identify knowledge gaps and goals.",
            details: [
          ...
          },
          {
            ...
            description: "Hands-on sessions tailored to your stack.",
            details: [
          ...
          },
          {
            ...
            description: "Guidance on real-world projects.",
            details: [
              "Code reviews",
          ...
          },
          {
            ...
            description: "Transition to automation roles.",
            details: [
              "Portfolio building",
